<!--
canonical-spec: web-service-catalog
status: active
source-change: archive/2026-08-09-web-services-ssot
source-spec: openspec/changes/archive/2026-08-09-web-services-ssot/specs/web-service-catalog/spec.md
-->

## Purpose

Defines the canonical requirements for the local web-service catalog capability.
