<!--
canonical-spec: litellm-gateway
status: active
source-change: archive/2026-06-17-migrate-bifrost-to-litellm
source-spec: openspec/changes/archive/2026-06-17-migrate-bifrost-to-litellm/specs/litellm-gateway/spec.md
-->

## Purpose

Defines the canonical requirements for the litellm gateway capability.
