...
1. Create canonical capability specs under `openspec/specs/` with provenance metadata.
1. Add an `openspec/specs/INDEX.md` file listing capability name, status, and source change.
1. Validate the new change strictly and keep bootstrap tasks checked as each step completes.
