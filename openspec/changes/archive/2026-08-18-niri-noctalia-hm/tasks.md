...
- [~] 8.4 Patch Noctalia's lock screen PAM - **tech debt**: user rarely locks screen; PAM patch busts Hydra cache (~9 min compile); revisit if upstream issue #3277 lands a config key
