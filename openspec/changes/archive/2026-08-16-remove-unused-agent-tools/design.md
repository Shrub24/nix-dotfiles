...
1. Update maintained documentation.
1. Evaluate the flake and Home Manager activation package.
1. Apply the Home Manager generation; rollback by restoring the prior generation if an undiscovered dependency exists.
