...
### Examples
GC Policy: automatic weekly via home-manager user timer nh-clean, retains 7 days of generations, auto-optimise-store enabled. Flake inputs count: 19 total inputs (9 core + 6 fish plugins + nvfetcher + fsel + 2 hermes-agent variants).
