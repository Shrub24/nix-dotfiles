...
Rule 2: The repository SHALL organize system-scoped modules and host entrypoints separately from user-scoped Home Manager modules so privilege boundaries are explicit
