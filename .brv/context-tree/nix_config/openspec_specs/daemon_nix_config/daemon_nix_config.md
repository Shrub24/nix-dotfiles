...
Rule 2: The system SHALL provide nixbuild.net access configuration in a way that is visible to daemon-scoped or root-scoped Nix execution without depending on an interactive user shell session
