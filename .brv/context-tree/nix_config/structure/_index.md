...
### Examples
Shell config: zsh via antidote (powerlevel10k, fzf-tab, zsh-vi-mode, eza, pay-respects), zsh-abbr for git/nix/file/systemd shortcuts. OpenCode: symlinks ~/.config/opencode → raw/opencode and ~/.agents → raw/agents via opencode.nix. Agentmemory: npm package with iii-engine in
