...
### Examples
Shell config: zsh via antidote (powerlevel10k, fzf-tab, zsh-vi-mode, eza, pay-respects), zsh-abbr for git/nix/file/systemd shortcuts. OpenCode: symlinks ~/.config/opencode → ${appsDir}/opencode and ~/.agents → ${appsDir}/agents via opencode.nix. Agentmemory: npm package with iii-engine in
[summary compaction; truncated from 1008 tokens]